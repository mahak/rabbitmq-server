...
rabbit_log:info("Starting recovery terms"),
    ok = rabbit_recovery_terms:start(VHost),
rabbit_log:info("Folding recovery terms over directories"),
...
rabbit_log:info("Cleaning up unrecovered"),
...
rabbit_log:info("Clear recovery terms"),
